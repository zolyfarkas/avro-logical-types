 ...
 * @author zfarkas
 */
public class LocalTimestampMicrosLogicalTypeFactory implements LogicalTypeFactory {
  ...
  public LogicalType fromSchema(final Schema schema) {
    ...
    if (type == Schema.Type.LONG) {
      ...
      throw new AvroRuntimeException("Unsupported schema for local timestamp micros " + schema);
    }
  }
